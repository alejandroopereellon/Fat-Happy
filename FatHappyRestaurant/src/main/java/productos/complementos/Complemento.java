package productos.complementos;

import jakarta.persistence.*;
import productos.Salsas;
...
public class Complemento extends Producto {
	...
	public List<Salsas> getSalsas() {
		return salsas;
	}

	public void setSalsas(List<Salsas> salsas) {
		this.salsas = salsas;
	}
