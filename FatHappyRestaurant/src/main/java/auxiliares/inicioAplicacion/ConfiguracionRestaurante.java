...
public class ConfiguracionRestaurante {
    ...
    private static final Logger logger = LogManager.getLogger(ConfiguracionRestaurante.class);
    private static final String RUTA_CONFIG = System.getProperty("user.home") + File.separator + "fathappyrestaurant" + File.separator + "config.json";
