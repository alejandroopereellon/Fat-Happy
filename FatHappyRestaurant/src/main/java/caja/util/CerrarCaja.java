...
public class CerrarCaja {
	...
	public boolean cerrarCaja() {
		...
		if (!new ActividadEmpleados().solicitarPermisos("Cierre de caja " + LocalDateTime.now(), 3)) {
			return false;
		}
	...
	/**
	 * Metodo que genera un ticket de cierre de caja y lo guarda en un archivo de
	 * texto. El ticket incluye los datos principales del cierre, empleado, importe
	 * y resumen de operaciones.
	 */
