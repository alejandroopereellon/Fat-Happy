...
public class PedidoSocket implements Serializable {
	...
	private List<PanelPedido> paneles = new ArrayList<PanelPedido>();
	...
	public List<PanelPedido> getPaneles() {
		if (paneles == null) {
			System.out.println("Paneles es nulo");
			paneles = new ArrayList<PanelPedido>();
		}
		return paneles;
	}
}
